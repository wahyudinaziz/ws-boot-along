...
/**
 * @typedef {Object} yamadaApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} yamadaApiProviderShape
 * @property {string} baseURL
 * @property {yamadaApiAuthShape} [auth]
...
/**
 * @typedef {Object} yamadaApiRequestOptions
...
/**
 * @typedef {Object} yamadaApiMultipartFile
 ...
 */
class yamadaApiProvider {
  /**
   * @param {yamadaApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {yamadaApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {yamadaApiMultipartFile[]|Object<string, any>} [files]
   * @param {yamadaApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends yamadaApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends yamadaApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends yamadaApiProvider {
...
class ApiFaaProvider extends yamadaApiProvider {
...
class yamadaMainApiProvider extends yamadaApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends yamadaApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends yamadaApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends yamadaApiProvider {
...
class AzbryApiProvider extends yamadaApiProvider {
...
class YuulabsApiProvider extends yamadaApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends yamadaApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends yamadaApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal yamada.
 */
class yamadaApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @returns {yamadaApiProviderShape}
   */
  ...
  /**
   * @param {string} name
   * @param {yamadaApiProviderShape} cfg
   * @returns {yamadaApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<yamadaApiProviderShape>} cfg
   * @returns {yamadaApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || yamadaApiProvider;
  ...
  makeProviders() {
    return {
      ...
      yamada: {
        baseURL: "https://api.yamada.my.id",
      },
    };
  }
...
const yamadaApi = new yamadaApiManager();

export { yamadaApiManager, yamadaApiProvider, yamadaApi };
export default yamadaApi;
