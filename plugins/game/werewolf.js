...
try {
  ...
  if (fs.existsSync(path.join(assetsPath, "yamada-games.jpg"))) {
    thumbWW = fs.readFileSync(path.join(assetsPath, "yamada-games.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "yamada.jpg"))) {
    thumbNight = fs.readFileSync(path.join(assetsPath, "yamada.jpg"));
    thumbDay = fs.readFileSync(path.join(assetsPath, "yamada.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "yamada-winner.jpg"))) {
    thumbWin = fs.readFileSync(path.join(assetsPath, "yamada-winner.jpg"));
  }
} catch (e) {
