...
import { addExifToWebp } from "../../src/lib/yamada-exif.js";
...
async function handler(m, { sock }) {
  ...
  try {
    ...
    const packname = randPick.name || config.sticker?.packname || "yamada-ai";
    const author = YAMADA_DEVELOPER || config.sticker?.author || "Bot";
